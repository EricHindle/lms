	...
	if($_SERVER['REQUEST_METHOD'] == 'POST')
    {
        ...
        else
        {
			if(login_check($mypdo) == true) {
				if ( isset($_POST['id'], $_POST['q16radio'], $_POST['q17radio'], $_POST['q18radio'], $_POST['q19radio'], $_POST['q20radio'], $_POST['comments3'])  ) {
					...
					if ($id && $answerCheck) {
						...
						$updateSql = "UPDATE svchks SET na = :na, q16 = :q16, q17 = :q17, q18 = :q18, q19 = :q19, q20 = :q20, s3 = :s3, comment3 = :comment, lastcompsection = :lastSection WHERE id = :id";
						$updateQuery = $mypdo->prepare($updateSql);
						$updateQuery->execute(array(':na'=>$nonapplicable, ':q16'=>$answerArray['q16'], ':q17'=>$answerArray['q17'], ':q18'=>$answerArray['q18'], ':q19'=>$answerArray['q19'], ':q20'=>$answerArray['q20'], ':s3'=>$sectionScore, ':comment'=>$comments, ':lastSection'=>3, ':id'=>$id));
