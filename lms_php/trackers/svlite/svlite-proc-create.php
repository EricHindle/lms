			...
			if(login_check($mypdo) == true) {
				if ( isset($_POST['cem_num'], $_POST['lbo'])  ) {
					...
					if ($lboid && $cem_num) {
						...
						$vequery->execute(array(':id'=>$lboid));
						...
						if($vecount>0){
							...
							$vesql2= "INSERT INTO svlitechks (id, num, shop, division, region, area, cluster, datestart, completedby, cem) VALUES (:ID, :num, :shop, :division, :region, :area, :cluster, :datestart, :completedby, :cem)";
