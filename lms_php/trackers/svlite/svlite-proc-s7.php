	...
	if($_SERVER['REQUEST_METHOD'] == 'POST')
    {
        ...
        else
        {
			if(login_check($mypdo) == true) {
				if ( isset($_POST['id'], $_POST['q21radio'], $_POST['q22radio'], $_POST['q23radio'], $_POST['q24radio'], $_POST['q25radio'], $_POST['q26radio'], $_POST['q27radio'], $_POST['q28radio'], $_POST['q29radio'], $_POST['q30radio'], $_POST['comments7'])  ) {
					...
					if ($id && $answerCheck) {
						...
						$updateSql = "UPDATE svlitechks SET na = :na, q21 = :q21, q22 = :q22, q23 = :q23, q24 = :q24, q25 = :q25, q26 = :q26, q27 = :q27, q28 = :q28, q29 = :q29, q30 = :q30, s7 = :s7, comment7 = :comment, lastcompsection = :lastSection WHERE id = :id";
						$updateQuery = $mypdo->prepare($updateSql);
						$updateQuery->execute(array(':na'=>$nonapplicable, ':q21'=>$answerArray['q21'], ':q22'=>$answerArray['q22'], ':q23'=>$answerArray['q23'], ':q24'=>$answerArray['q24'], ':q25'=>$answerArray['q25'], ':q26'=>$answerArray['q26'], ':q27'=>$answerArray['q27'], ':q28'=>$answerArray['q28'], ':q29'=>$answerArray['q29'], ':q30'=>$answerArray['q30'], ':s7'=>$sectionScore, ':comment'=>$comments, ':lastSection'=>7, ':id'=>$id));
