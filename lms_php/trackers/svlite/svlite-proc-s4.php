	...
	if($_SERVER['REQUEST_METHOD'] == 'POST')
    {
        ...
        else
        {
			if(login_check($mypdo) == true) {
				if ( isset($_POST['id'], $_POST['q7radio'], $_POST['q8radio'], $_POST['q9radio'], $_POST['q10radio'], $_POST['q11radio'], $_POST['q12radio'], $_POST['q13radio'], $_POST['comments4'])  ) {
					...
					if ($id && $answerCheck) {
						...
						$updateSql = "UPDATE svlitechks SET na = :na, q7 = :q7, q8 = :q8, q9 = :q9, q10 = :q10, q11 = :q11, q12 = :q12, q13 = :q13, s4 = :s4, comment4 = :comment, lastcompsection = :lastSection WHERE id = :id";
						$updateQuery = $mypdo->prepare($updateSql);
						$updateQuery->execute(array(':na'=>$nonapplicable, ':q7'=>$answerArray['q7'], ':q8'=>$answerArray['q8'], ':q9'=>$answerArray['q9'], ':q10'=>$answerArray['q10'], ':q11'=>$answerArray['q11'], ':q12'=>$answerArray['q12'], ':q13'=>$answerArray['q13'], ':s4'=>$sectionScore, ':comment'=>$comments, ':lastSection'=>4, ':id'=>$id));
