<?php
	...
	if(login_check($mypdo) == true && $_SESSION['retaccess']==999) {
		...
		$sql = "SELECT MAX(datecomplete), MIN(datecomplete) FROM svchkscomp";
		...
		echo '
			    ...
			    <br><br>
			        <div class="container backwhite">
			            <div class="row">
			                <div class="col-md-12">
			                    <h1 class="inWhite addShad"><strong>Smart Visit Data</strong></h1>
			                    <br><br><br><br>
			                </div>
			      		</div>
			      		<div class="row">
			      			<div class="well well-xs col-xs-10 col-xs-offset-1">
								...
								<br><br>
								<form class="form-horizontal" role="form" name ="showcalls" method="post"  action="show-sv-surveys.php"">
									' . $key . '
