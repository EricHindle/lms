...
DROP TABLE IF EXISTS `lms_calendar`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `lms_calendar` (
  `lms_calendar_id` int NOT NULL,
  `lms_calendar_name` varchar(45) NOT NULL DEFAULT '',
  `lms_calendar_season` int NOT NULL,
  `lms_calendar_current_week` int NOT NULL DEFAULT '0',
  `lms_calendar_select_week` int NOT NULL DEFAULT '0',
